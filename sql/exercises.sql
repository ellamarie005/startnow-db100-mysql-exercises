...
select payment_date,
amount from payment
descending order by amount limit 20;
...
rental_duration
from film
where length < 120 and special_features like '%Behind The Scene%' and rental_duration between 5 and 7
